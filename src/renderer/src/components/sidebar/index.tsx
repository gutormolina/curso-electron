...
import { LinkContent } from '../link/index.js'
...
export function Sidebar(){
    ...
    return(
        ...
        >
            ...
            <div
                className={clsx(
                    'flex-1 flex flex-col h-full gap-8 w-[220px] transition-opacity group-data-[state=open]:opacity-100 group-date-[state=closed]:opacity-0 duration-200',
                    {
                        'pt-6': !isMacOS
                    }
                )}
